...
Unfortunately, you can't use this add on when you are using ITSMIncidentProblemManagement or any other module that overrides C<Kernel::Modules::AgentTicketPrint>. Currently this add on is only available for OTRS 3.0.x.
